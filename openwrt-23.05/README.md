# OpenWrt 23.05 repository

This archived feed provides IPK packages for OpenWrt 23.05. For OpenWrt
25.12, use the [APK installation instructions](../openwrt-25.12/) instead.

Available architectures: `aarch64_cortex-a53`, `aarch64_cortex-a72`, `arm_cortex-a15_neon-vfpv4`,
`arm_cortex-a9_vfpv3-d16`, `mips_24kc`, `mipsel_24kc`, and `x86_64`.

Run these commands as root on a router running OpenWrt 23.05.
...
```sh
echo "src/gz arition_repo https://arition.github.io/openwrt-repo/openwrt-23.05/<your-router-arch>" >> /etc/opkg/customfeeds.conf
opkg update
